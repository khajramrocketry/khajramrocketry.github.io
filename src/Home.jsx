...
function Meteors({ children, count = 50, angle = 215, color = "#e9eaeb", tailColor = "#64748b" }) {
  ...
  return (
    <div style={{ position: "relative", inset: 0, overflow: "hidden", background: "#0a0a0f", width: "100vw"}}>
      <style>{`
      ...
      <div>
        ...
        >
          ...
          <div className="main_content">
              ...
              <p className="info_text">We are an engineering project team specializing in launching rockets and 
